...
<div class="container">
    ...
    <table class="table table-striped table-bordered">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($manage == 'attendees') {
                echo "<td width='17%'>
                <a href='attendee_list.php?event_id={$row['event_id']}'><button class='button primary small' 
                    style='font-size:small; margin:auto; display:block; margin-bottom:5px;'>Check attendees</button></a>
                <a href='attendee_invite.php?event_id={$row['event_id']}'><button class='button primary small' 
                    style='background-color:mediumseagreen; font-size:small; margin:auto; display:block;'>Invite attendees</button></a>
                </td>";
            }
            else if ($manage == 'staff') {
                echo "<td width='17%'>
